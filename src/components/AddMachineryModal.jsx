...
const AddMachineryModal = ({ onClose, onAdd }) => {
      ...
      >
        ...
        >
          <div className="flex items-center gap-3 text-white">
            ...
            <h2 className="text-xl font-bold tracking-wide">Add Machinery</h2>
          </div>
          <Button 
            onClick={onClose} 
            variant="ghost" 
        ...
        <div className="p-6 overflow-y-auto">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-4">
                ...
                <div>
                  <label className="block text-blue-200 mb-1.5 text-sm font-medium">Machinery Name</label>
                  <input
                      type="text"
                      name="name"
                      value={formData.name}
                ...
                <div>
                  <label className="block text-blue-200 mb-1.5 text-sm font-medium">Type</label>
                  <input
                      type="text"
                      name="type"
                      value={formData.type}
                ...
                <div>
                  <label className="block text-blue-200 mb-1.5 text-sm font-medium">Description/Details</label>
                  <textarea
                      name="details"
                      ...
                      placeholder="e.g. Model 320D, Year 2018..."
                  />
                </div>
